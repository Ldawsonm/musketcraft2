...
summon block_display ~ ~ ~ {Tags:["glob_display","no_id"],block_state:{Name:"minecraft:nether_wart_block"},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.5f,0f,-0.5f],scale:[1f,1f,1f]},interpolation_duration:40}

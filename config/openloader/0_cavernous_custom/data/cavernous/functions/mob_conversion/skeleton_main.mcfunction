...
execute if entity @s[tag=!converted] if predicate cavernous:conversion/skeleton_to_mossclad run function cavernous:mob_conversion/mossclad_replace
...
execute if entity @s[tag=!converted] if predicate cavernous:conversion/skeleton_to_ghost run function cavernous:myst/mobs/ghost/convert

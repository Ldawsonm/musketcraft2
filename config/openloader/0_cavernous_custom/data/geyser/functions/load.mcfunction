...
execute unless score .global geyser.has_uninstalled matches 1 run scoreboard players set .global geyser.enabled 0
execute unless score .global geyser.has_uninstalled matches 1 run scoreboard players set .global geyser.uninstalled 1
